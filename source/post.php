...
if ($uploadOk == 0) {
  echo "Sorry, your file was not uploaded, but the post did.";
...
$ttext = $_POST['ttext']; //Pentru ca nu vr sa am probleme cu php nu am numit "text", ci "ttext".
$sql = "insert into forum (id_op, subject, ttext, filename) values ($id, '$subject', '$ttext', '$filename')";
